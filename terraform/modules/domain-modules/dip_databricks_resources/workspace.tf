...
resource "databricks_mws_networks" "this" {
  ...
  network_name = "dip-dbx-${local.selected_env}-${local.normalized_domain_name}${local.normalized_subdomain_name != "" ? "-${local.normalized_subdomain_name}" : ""}-${random_string.network_name_suffix.result}-network"
...
resource "databricks_mws_credentials" "this" {
  provider         = databricks.mws
  credentials_name = "dip-dbx-${local.selected_env}-${local.normalized_domain_name}${local.normalized_subdomain_name != "" ? "-${local.normalized_subdomain_name}" : ""}-${random_string.credential_name_suffix.result}-credentials"
...
resource "databricks_mws_storage_configurations" "this" {
  provider                   = databricks.mws
  account_id                 = local.databricks_account_id
  storage_configuration_name = "dip-dbx-${local.selected_env}-${local.normalized_domain_name}${local.normalized_subdomain_name != "" ? "-${local.normalized_subdomain_name}" : ""}-${random_string.storage_name_suffix.result}-stoarge"
...
resource "databricks_mws_workspaces" "this" {
  ...
  workspace_name           = "dip-dbx-xcadi-${local.selected_env}-${local.normalized_domain_name}${local.normalized_subdomain_name != "" ? "-${local.normalized_subdomain_name}" : ""}"
